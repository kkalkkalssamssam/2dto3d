...
public:
    ...
    void PubPointCloud(Gl::framedata_t frame_data, double theta);
...
void Scanner::msgCallback(const std_msgs::Int16::ConstPtr & msg)
{
    if (msg->data == WAIT) {
        ...
        PubPointCloud(frame_data, theta);
    }
}
...
void Scanner::PubPointCloud(Gl::framedata_t frame_data, double theta)
{
